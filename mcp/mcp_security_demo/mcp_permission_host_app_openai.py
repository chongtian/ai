...
class MCPPermissionHostApp(MCPPermissionClient):
    ...
    def __init__(self, server_script: str):
        ...
        # Either set OPENAI_API_KEY in environment or configure it here directly (not recommended for security reasons)
        # bash:
...
def main():
    ...
    interface.queue().launch(server_name="127.0.0.1", server_port=7865)
