...
class MCPPermissionHostApp(MCPPermissionClient):
    ...
    def __init__(self, server_script: str):
        ...
        # this is only for qwen models 
        self.conversation_history.append({"role": "system", "content": "You shall respond in English."})
    ...
    def create_interface(self):
        ...
        with gr.Blocks(title="MCP Permission AI Host") as interface:
            ...
            Chat with {self.model} using permission-aware MCP tools.
...
def main():
    ...
    interface.queue().launch(server_name="127.0.0.1", server_port=7866)
